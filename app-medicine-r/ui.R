                                                                                                                         ...
                                                                                                                         if(i18n$get_translation_language()=="es"){
                                                                                                                           choices = c("Cirugía general"="CIRUGÍA GENERAL","Cirugía cardiovascular"="CIRUGÍA CARDIOVASCULAR",
                                                                                                                                     ...
                                                                                                                                     , "Resto especialdiades"="RESTO ESPECIALIDADES", "Todas"="TODAS")}
                                                                                                                                          ...
                                                                                                                                          , "Neurosurgery"="NEUROCIRUGÍA", "Otorhinolaryngology"="OTORRINOLARINGOLOGÍA", "Ophthalmology"="OFTALMOLOGÍA"
                                                                                                                                          , "Obstetrics and gynecology"="OBSTETRICIA Y GINECOLOGÍA", "Gynecology"="GINECOLOGÍA", "Urology"="UROLOGÍA"
                                                                                                                                          , "Other specialties"="RESTO ESPECIALIDADES", "All"="TODAS")}
                                                                                                                           )),
