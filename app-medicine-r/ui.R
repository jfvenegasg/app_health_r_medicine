              ...
              fluidRow(width=12,                
                       ...
                       column(width = 3,
                              ...
                              box(width = 12,headerBorder = FALSE,collapsible = FALSE,closable = FALSE,elevation = 2,status = "lightblue",selectInput("selector_2",i18n$t("Seleccion de mes"),
                                                                                                                                          ...
                                                                                                                                          else{choices=c("January"="enero","February"="febrero",
                                                                                                                                                         "March"="marzo", "April"="abril", "May"="mayo", "June"="junio", "July"="julio", "August"="agosto"
                                                                                                                                                         , "September"="septiembre", "October"="obtubre", "November"="noviembre" , "December"="diciembre", "Año 2022"="año 2022")
                                                                                                                                            })),
